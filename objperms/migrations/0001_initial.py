...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('objperms_objectpermission', (
        ...
        db.send_create_signal('objperms', ['ObjectPermission'])


    def backwards(self, orm):
        
        # Deleting model 'ObjectPermission'
        db.delete_table('objperms_objectpermission')
