...
urlpatterns = patterns('signupbox.views',
    ...
    (r'^accounts/$', 'accounts', {}, 'accounts',),
    (r'^admin/settings/$', 'account_settings', {}, 'account_settings',),
    (r'^admin/exports/$', 'account_exports', {}, 'account_exports',),
    ...
    (r'^admin/gviz/$', 'event_gviz', {}, 'event_gviz',),
    (r'^admin/add/$', 'event_create', {}, 'event_create',),
    (r'^admin/archived/$', 'archived', {}, 'archived',),
    (r'^admin/(?P<slug>[-\w]+)/$', 'event_detail', {}, 'event_detail',),
    (r'^admin/(?P<slug>[-\w]+)/edit/$', 'event_edit', {}, 'event_edit',),
    (r'^admin/(?P<slug>[-\w]+)/copy/$', 'event_copy', {}, 'event_copy',),
    (r'^admin/(?P<slug>[-\w]+)/edit-confirmation-mail/$', 'event_edit_confirmation_mail', {}, 'event_edit_confirmation_mail',),
    (r'^admin/(?P<slug>[-\w]+)/subscribe/$', 'event_subscribe', {}, 'event_subscribe',),
    (r'^admin/(?P<slug>[-\w]+)/unsubscribe/$', 'event_unsubscribe', {}, 'event_unsubscribe',),
    (r'^admin/(?P<slug>[-\w]+)/archive/$', 'event_archive', {}, 'event_archive',),
    (r'^admin/(?P<slug>[-\w]+)/unarchive/$', 'event_unarchive', {}, 'event_unarchive',),
    ...
    (r'^admin/(?P<slug>[-\w]+)/attendees/add/$', 'event_attendees_add', {}, 'event_attendees_add',),
    ...
    (r'^(?P<slug>[-\w]+)/register/complete/(?P<token>[-\w]+)/$', 'event_complete', {}, 'event_complete',),
    (r'^(?P<slug>[-\w]+)/register/more/$', 'event_view_more', {}, 'event_view_more',),
