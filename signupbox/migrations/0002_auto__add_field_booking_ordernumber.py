...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.ordernumber'
        db.add_column('signupbox_booking', 'ordernumber', self.gf('django.db.models.fields.CharField')(default='1', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.ordernumber'
        db.delete_column('signupbox_booking', 'ordernumber')
