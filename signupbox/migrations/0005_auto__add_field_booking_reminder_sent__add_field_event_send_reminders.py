...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('signupbox_attendee', 'reminder_sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('signupbox_attendee', 'reminder_sent')
