...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelationWiseSurvey.language_parameter'
        db.add_column('signupbox_relationwisesurvey', 'language_parameter', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RelationWiseSurvey.language_parameter'
        db.delete_column('signupbox_relationwisesurvey', 'language_parameter')
