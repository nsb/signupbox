...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RelationWiseSurvey'
        db.create_table('signupbox_relationwisesurvey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='surveys', to=orm['signupbox.Account'])),
            ('survey_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('signupbox', ['RelationWiseSurvey'])

        # Adding field 'Event.survey'
        db.add_column('signupbox_event', 'survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['signupbox.RelationWiseSurvey']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RelationWiseSurvey'
        db.delete_table('signupbox_relationwisesurvey')

        # Deleting field 'Event.survey'
        db.delete_column('signupbox_event', 'survey_id')
    ...
    models = {
        ...
        'signupbox.event': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'null': 'True', 'to': "orm['signupbox.RelationWiseSurvey']"}),
