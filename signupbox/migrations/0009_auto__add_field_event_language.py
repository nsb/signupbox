...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.language'
        db.add_column('signupbox_event', 'language',
                      self.gf('django.db.models.fields.CharField')(default='da', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.language'
        db.delete_column('signupbox_event', 'language')
