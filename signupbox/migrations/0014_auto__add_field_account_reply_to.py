...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.reply_to'
        db.add_column('signupbox_account', 'reply_to', self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.reply_to'
        db.delete_column('signupbox_account', 'reply_to')
