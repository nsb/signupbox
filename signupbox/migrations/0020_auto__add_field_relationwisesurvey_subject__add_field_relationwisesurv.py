...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelationWiseSurvey.subject'
        db.add_column('signupbox_relationwisesurvey', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=1024), keep_default=False)

        # Adding field 'RelationWiseSurvey.message'
        db.add_column('signupbox_relationwisesurvey', 'message', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RelationWiseSurvey.subject'
        db.delete_column('signupbox_relationwisesurvey', 'subject')

        # Deleting field 'RelationWiseSurvey.message'
        db.delete_column('signupbox_relationwisesurvey', 'message')
