...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.project_id'
        db.add_column('signupbox_event', 'project_id', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.project_id'
        db.delete_column('signupbox_event', 'project_id')
