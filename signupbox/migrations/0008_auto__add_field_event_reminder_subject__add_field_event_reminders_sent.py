...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.reminder_subject'
        db.add_column('signupbox_event', 'reminder_subject', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True), keep_default=False)

        # Adding field 'Event.reminders_sent'
        db.add_column('signupbox_event', 'reminders_sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.reminder_subject'
        db.delete_column('signupbox_event', 'reminder_subject')

        # Deleting field 'Event.reminders_sent'
        db.delete_column('signupbox_event', 'reminders_sent')
