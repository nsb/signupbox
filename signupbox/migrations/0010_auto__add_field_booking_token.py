...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.token'
        db.add_column('signupbox_booking', 'token', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.token'
        db.delete_column('signupbox_booking', 'token')
