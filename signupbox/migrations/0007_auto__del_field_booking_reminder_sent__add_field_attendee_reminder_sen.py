...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.send_reminder'
        db.add_column('signupbox_event', 'send_reminder', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Event.reminder'
        db.add_column('signupbox_event', 'reminder', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.send_reminder'
        db.delete_column('signupbox_event', 'send_reminder')

        # Deleting field 'Event.reminder'
        db.delete_column('signupbox_event', 'reminder')
