...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.script_codes'
        db.add_column('signupbox_account', 'script_codes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.script_codes'
        db.delete_column('signupbox_account', 'script_codes')
