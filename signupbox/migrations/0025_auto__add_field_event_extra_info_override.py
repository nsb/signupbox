...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.extra_info_override'
        db.add_column('signupbox_event', 'extra_info_override', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.extra_info_override'
        db.delete_column('signupbox_event', 'extra_info_override')
