...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.from_address'
        db.add_column('signupbox_account', 'from_address', self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.from_address'
        db.delete_column('signupbox_account', 'from_address')
