...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.confirmation_mail'
        db.add_column('signupbox_event', 'confirmation_mail', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Event.confirmation_mail_registrant'
        db.add_column('signupbox_event', 'confirmation_mail_registrant', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.confirmation_mail'
        db.delete_column('signupbox_event', 'confirmation_mail')

        # Deleting field 'Event.confirmation_mail_registrant'
        db.delete_column('signupbox_event', 'confirmation_mail_registrant')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 10, 15, 59, 35, 424863)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 10, 15, 59, 35, 424743)'}),
        ...
        'signupbox.event': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'confirmation_mail': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'confirmation_mail_registrant': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'extra_info_override': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'redirect_public_page_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'show_newsletter_subscribe': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'signupbox.relationwisesurvey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_parameter': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
