...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.relationwise_survey_id'
        db.add_column('signupbox_account', 'relationwise_survey_id', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.relationwise_survey_id'
        db.delete_column('signupbox_account', 'relationwise_survey_id')
