...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.relationwise_api_key'
        db.add_column('signupbox_account', 'relationwise_api_key', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'Event.surveyEnabled'
        db.add_column('signupbox_event', 'surveyEnabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.surveySent'
        db.add_column('signupbox_event', 'surveySent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.relationwise_api_key'
        db.delete_column('signupbox_account', 'relationwise_api_key')

        # Deleting field 'Event.surveyEnabled'
        db.delete_column('signupbox_event', 'surveyEnabled')

        # Deleting field 'Event.surveySent'
        db.delete_column('signupbox_event', 'surveySent')
    ...
    models = {
        ...
        'signupbox.account': {
            ...
            'relationwise_api_key': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
