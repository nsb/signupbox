...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.redirect_public_page_url'
        db.add_column('signupbox_event', 'redirect_public_page_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.redirect_public_page_url'
        db.delete_column('signupbox_event', 'redirect_public_page_url')
