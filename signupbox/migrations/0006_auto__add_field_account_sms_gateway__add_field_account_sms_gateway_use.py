...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.sms_gateway'
        db.add_column('signupbox_account', 'sms_gateway', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Account.sms_gateway_username'
        db.add_column('signupbox_account', 'sms_gateway_username', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Account.sms_gateway_password'
        db.add_column('signupbox_account', 'sms_gateway_password', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.sms_gateway'
        db.delete_column('signupbox_account', 'sms_gateway')

        # Deleting field 'Account.sms_gateway_username'
        db.delete_column('signupbox_account', 'sms_gateway_username')

        # Deleting field 'Account.sms_gateway_password'
        db.delete_column('signupbox_account', 'sms_gateway_password')
