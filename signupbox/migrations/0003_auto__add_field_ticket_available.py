...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.available'
        db.add_column('signupbox_ticket', 'available', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.available'
        db.delete_column('signupbox_ticket', 'available')
