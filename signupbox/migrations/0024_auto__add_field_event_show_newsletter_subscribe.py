...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.show_newsletter_subscribe'
        db.add_column('signupbox_event', 'show_newsletter_subscribe', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.show_newsletter_subscribe'
        db.delete_column('signupbox_event', 'show_newsletter_subscribe')
