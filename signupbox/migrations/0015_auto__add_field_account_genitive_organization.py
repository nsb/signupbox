...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.genitive_organization'
        db.add_column('signupbox_account', 'genitive_organization', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.genitive_organization'
        db.delete_column('signupbox_account', 'genitive_organization')
